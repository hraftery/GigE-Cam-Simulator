    ...
    public static class RegisterTypeHelper
    {
        ...
        static RegisterInfo[] CreateRegisterInfoList()
        {
            var values = new List<RegisterInfo>
            {
                ...
                new RegisterInfo(RegisterTypes.Network_interface_capability_0,                          0x0010, 4),
                new RegisterInfo(RegisterTypes.Network_interface_configuration_0,                       0x0014, 4),
                ...
                new RegisterInfo(RegisterTypes.Device_MAC_address_High_Network_interface_1,             0x0680, 4),
                new RegisterInfo(RegisterTypes.Device_MAC_address_Low_Network_interface_1,              0x0684, 4),
                new RegisterInfo(RegisterTypes.Network_interface_capability_1,                          0x0688, 4),
                new RegisterInfo(RegisterTypes.Network_interface_configuration_1,                       0x068C, 4),
                ...
                new RegisterInfo(RegisterTypes.Device_MAC_address_High_Network_interface_2,             0x0700, 4),
                new RegisterInfo(RegisterTypes.Device_MAC_address_Low_Network_interface_2,              0x0704, 4),
                new RegisterInfo(RegisterTypes.Network_interface_capability_2,                          0x0708, 4),
                new RegisterInfo(RegisterTypes.Network_interface_configuration_2,                       0x070C, 4),
                ...
                new RegisterInfo(RegisterTypes.Device_MAC_address_High_Network_interface_3,             0x0780, 4),
                new RegisterInfo(RegisterTypes.Device_MAC_address_Low_Network_interface_3,              0x0784, 4),
                new RegisterInfo(RegisterTypes.Network_interface_capability_3,                          0x0788, 4),
                new RegisterInfo(RegisterTypes.Network_interface_configuration_3,                       0x078C, 4),
                ...
                new RegisterInfo(RegisterTypes.GVSP_Capability,                                         0x092C, 4),
                ...
                new RegisterInfo(RegisterTypes.GVSP_Configuration,                                      0x0960, 4),
                new RegisterInfo(RegisterTypes.Physical_Link_Capability,                                0x0964, 4),
                new RegisterInfo(RegisterTypes.Physical_Link_Configuration,                             0x0968, 4),
                new RegisterInfo(RegisterTypes.IEEE_1588_Status,                                        0x096C, 4),
                new RegisterInfo(RegisterTypes.Scheduled_Action_Command_Queue_Size,                     0x0970, 4),
                new RegisterInfo(RegisterTypes.IEEE_1588_Extended_Capabilities,                         0x0974, 4),
                new RegisterInfo(RegisterTypes.IEEE_1588_Supported_Profiles,                            0x0978, 4),
                new RegisterInfo(RegisterTypes.IEEE_1588_Selected_Profile,                              0x097C, 4),
